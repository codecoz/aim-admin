...
class MakeAimRequest extends GeneratorCommand
{
    /**
     ...
     * @var string
     */
    protected $name = 'aim:make-request';
     ...
     * @deprecated
     */
    protected static $defaultName = 'aim-admin:make-request';
    ...
    {
        return $this->resolveStubPath('/stubs/aim-admin.request.stub');
    }
