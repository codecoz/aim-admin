...
class MakeAimServiceInterface extends GeneratorCommand
{
    /**
     ...
     * @deprecated
     */
    protected static $defaultName = 'aim:make-service-interface';
    ...
    {
        return $this->resolveStubPath('/stubs/aim-admin.service.interface.stub');
    }
